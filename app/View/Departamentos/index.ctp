<div class="departamentos index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('direccion_id'); ?></th>
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($departamento['Direccion']['nombre'], array('controller' => 'direccions', 'action' => 'view', $departamento['Direccion']['id'])); ?>
		</td>
		<td class="actions">
